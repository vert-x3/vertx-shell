...
+++
@return the <code>shell.html</code> resource for this server
+++
...
+++
@return the <code>term.js</code> resource for this server
+++
...
+++
@return the <code>vertxshell.js</code> resource for this server
+++
