...
It can be achieved via the `java.util.ServiceLoader` of a `link:../../jsdoc/command_pack-CommandPack.html[CommandPack]`.
...
NOTE: this is only valid for the `link:../../jsdoc/shell_service-ShellService.html[ShellService]`. `link:../../jsdoc/shell_server-ShellServer.html[ShellServer]`
