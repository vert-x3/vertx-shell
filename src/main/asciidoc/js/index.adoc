...
It can be achieved via the `java.util.ServiceLoader` of a `link:../../jsdoc/command_resolver-CommandResolver.html[CommandResolver]`.
...
For shell servers, the command pack can be an argument of `link:../../jsdoc/command_registry-CommandRegistry.html#registerCommands[registerCommands]`.