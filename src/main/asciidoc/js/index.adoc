...
When the size of the terminal changes the `link:jsdoc/command_process-CommandProcess.html#resizehandler[resizehandler]` is notified, the new terminal size can be obtained
