...
Alternatively, an {@link io.vertx.ext.auth.authentication.AuthenticationProvider} can be {@link io.vertx.ext.shell.term.TermServer#authProvider(io.vertx.ext.auth.authentication.AuthenticationProvider) set}
