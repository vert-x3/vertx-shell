...
The telnet connector is configured by `link:../../apidocs/io/vertx/ext/shell/ShellServiceOptions.html#setTelnetOptions-io.vertx.ext.shell.term.TelnetTermOptions-[setTelnetOptions]`,
...
The SSH connector is configured by `link:../../apidocs/io/vertx/ext/shell/ShellServiceOptions.html#setSSHOptions-io.vertx.ext.shell.term.SSHTermOptions-[setSSHOptions]`:
...
- `link:../../apidocs/io/vertx/ext/shell/term/SSHTermOptions.html#setShiroAuthOptions-io.vertx.ext.auth.shiro.ShiroAuthOptions-[setShiroAuthOptions]`: configures user authentication
...
In process shell session can be created with `link:../../apidocs/io/vertx/ext/shell/ShellServer.html#createShell--[createShell]`:
