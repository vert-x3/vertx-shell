...
A command is created by the `link:../../apidocs/io/vertx/ext/shell/command/CommandBuilder.html#builder-java.lang.String-[CommandBuilder.builder]` method: the command process handler is called
