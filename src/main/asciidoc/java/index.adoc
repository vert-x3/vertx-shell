...
- `link:../../apidocs/io/vertx/ext/shell/term/HttpTermOptions.html#setShiroAuthOptions-io.vertx.ext.auth.shiro.ShiroAuthOptions-[setShiroAuthOptions]`: configures user authentication
...
It can be achieved via the `java.util.ServiceLoader` of a `link:../../apidocs/io/vertx/ext/shell/registry/CommandResolver.html[CommandResolver]`.
...
For shell servers, the command pack can be an argument of `link:../../apidocs/io/vertx/ext/shell/registry/CommandRegistry.html#registerCommands-io.vertx.ext.shell.registry.CommandResolver-[registerCommands]`.