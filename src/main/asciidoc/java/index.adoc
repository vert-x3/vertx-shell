...
The `link:../../apidocs/io/vertx/ext/shell/io/Tty.html#resizehandler-io.vertx.core.Handler-[resizehandler]` is useful for being noticed when the user resize the terminal
window:
