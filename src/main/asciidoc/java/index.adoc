...
- `link:../../apidocs/io/vertx/ext/shell/term/SSHOptions.html#setShiroAuthOptions-io.vertx.ext.shell.auth.ShiroAuthOptions-[setShiroAuthOptions]`: configures user authentication
...
with the shell. A `link:../../apidocs/io/vertx/ext/shell/command/CommandProcess.html[CommandProcess]` extends `link:../../apidocs/io/vertx/ext/shell/io/Tty.html[Tty]`
...
The `link:../../apidocs/io/vertx/ext/shell/io/Tty.html#setStdin-io.vertx.ext.shell.io.Stream-[setStdin]` handler is used to be notified when the terminal
...
When the size of the terminal changes the `link:../../apidocs/io/vertx/ext/shell/io/Tty.html#resizehandler-io.vertx.core.Handler-[resizehandler]`
...
The terminal type is useful for sending escape codes to the remote terminal: `link:../../apidocs/io/vertx/ext/shell/io/Tty.html#type--[type]`
...
The `link:../../apidocs/io/vertx/ext/shell/io/Pty.html[Pty]` pseudo terminal is the main interface for interacting with the command
when it's running:
...
The `link:../../apidocs/io/vertx/ext/shell/term/Term.html[Term]` is also a `link:../../apidocs/io/vertx/ext/shell/io/Tty.html[Tty]`, this section explains
how to use the tty.