...
When the size of the terminal changes the `link:yardoc/VertxShell/CommandProcess.html#resizehandler-instance_method[resizehandler]` is notified, the new terminal size can be obtained
