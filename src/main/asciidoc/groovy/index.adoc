...
It can be achieved via the `java.util.ServiceLoader` of a `link:../../groovydoc/io/vertx/groovy/ext/shell/command/CommandPack.html[CommandPack]`.
...
For shell servers, the command pack can be an argument of `link:../../groovydoc/io/vertx/groovy/ext/shell/registry/CommandRegistry.html#registerCommands(io.vertx.ext.shell.command.CommandPack)[registerCommands]`.