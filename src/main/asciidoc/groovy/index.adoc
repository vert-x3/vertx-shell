...
An HTTP term can start its own HTTP server, or it can reuse an existing Vert.x Web `link:../../vertx-web/groovy/groovydoc/io/vertx/groovy/ext/web/Router.html[Router]`.
