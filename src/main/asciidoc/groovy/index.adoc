...
NOTE: this is only valid for the `link:../../groovydoc/io/vertx/groovy/ext/shell/ShellService.html[ShellService]`. `link:../../groovydoc/io/vertx/groovy/ext/shell/ShellServer.html[ShellServer]`
