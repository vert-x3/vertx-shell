...
`link:groovydoc/io/vertx/groovy/ext/shell/ShellService.html#createShell()[createShell]` returns a `link:groovydoc/io/vertx/groovy/ext/shell/system/Shell.html[shell session]`.
