...
A command can set a `link:groovydoc/io/vertx/groovy/ext/shell/command/CommandProcess.html#setStdin(io.vertx.ext.shell.Stream)[setStdin]` handler
...
A command can use the `link:groovydoc/io/vertx/groovy/ext/shell/command/CommandProcess.html#stdout()[stdout]` to write to the standard output.
...
with `link:groovydoc/io/vertx/groovy/ext/shell/command/CommandProcess.html#width()[width]` and `link:groovydoc/io/vertx/groovy/ext/shell/command/CommandProcess.html#height()[height]`.