...
When the size of the terminal changes the `link:groovydoc/io/vertx/groovy/ext/shell/command/CommandProcess.html#resizehandler(io.vertx.core.Handler)[resizehandler]` is notified, the new terminal size can be obtained
