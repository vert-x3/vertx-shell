...
module VertxShell
  ...
  class CommandRegistry
    ...
    # @overload registerCommands(resolver)
    ...
    # @overload registerCommands(resolver,doneHandler)
    #   @param [::VertxShell::CommandResolver] resolver the commands to resolve from
    #   @yield 
    ...
    def register_commands(param_1=nil)
      if param_1.class.method_defined?(:j_del) && !block_given?
        @j_del.java_method(:registerCommands, [Java::IoVertxExtShellRegistry::CommandResolver.java_class]).call(param_1.j_del)
        return self
      elsif param_1.class == Array && !block_given?
        ...
        @j_del.java_method(:registerCommands, [Java::IoVertxExtShellRegistry::CommandResolver.java_class,Java::IoVertxCore::Handler.java_class]).call(param_1.j_del,(Proc.new { |ar| yield(ar.failed ? ar.cause : nil, ar.succeeded ? ar.result.to_a.map { |elt| ::Vertx::Util::Utils.safe_create(elt,::VertxShell::CommandRegistration) } : nil) }))
        return self
      elsif param_1.class == Array && block_given?
