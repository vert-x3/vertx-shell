...
# Generated from io.vertx.ext.shell.net.TtySocket
module VertxShell
  #  @author <a href="mailto:julien@julienviet.com">Julien Viet</a>
  class TtySocket < ::VertxShell::Tty
    # @private
    # @param j_del [::VertxShell::TtySocket] the java delegate
    def initialize(j_del)
      super(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxShell::TtySocket] the underlying java delegate
    def j_del
      @j_del
    end
    # @yield 
