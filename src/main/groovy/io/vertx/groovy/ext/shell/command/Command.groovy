...
public class Command {
  ...
  public static Command create(Vertx vertx, String name) {
    def ret= InternalHelper.safeCreate(io.vertx.ext.shell.command.Command.create((io.vertx.core.Vertx)vertx.getDelegate(), name), io.vertx.ext.shell.command.Command.class, io.vertx.groovy.ext.shell.command.Command.class);
    return ret;
  }
  public String name() {
