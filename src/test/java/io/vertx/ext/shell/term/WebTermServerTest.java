...
public class WebTermServerTest {
  ...
  public void testServerWrite(TestContext context) {
    ...
    server = TermServer.createWebTermServer(vertx, new WebTermOptions().setHttpServerOptions(new HttpServerOptions().setPort(8080)));
  ...
  public void testInitialSize(TestContext context) {
    testSize(context, "/term/websocket?cols=100&rows=50", 100, 50);
  }

  @Test
  public void testInitialSizeCols(TestContext context) {
    testSize(context, "/term/websocket?cols=100", 100, 24);
  }

  @Test
  public void testInitialSizeRows(TestContext context) {
    testSize(context, "/term/websocket?rows=50", 80, 50);
  }

  @Test
  public void testInitialSizeNegative1(TestContext context) {
    testSize(context, "/term/websocket?cols=100&rows=-50", 80, 24);
  }
  ...
  public void testInitialSizeNegative3(TestContext context) {
    testSize(context, "/term/websocket?rows=-50", 80, 24);
  }

  @Test
  public void testInitialSizeNegative4(TestContext context) {
    testSize(context, "/term/websocket?cols=-100", 80, 24);
  }

  @Test
  public void testInitialSizeInvalid1(TestContext context) {
    testSize(context, "/term/websocket?cols=100&rows=abc", 80, 24);
  }

  @Test
  public void testInitialSizeInvalid2(TestContext context) {
    testSize(context, "/term/websocket?cols=abc&rows=50", 80, 24);
  }

  @Test
  public void testInitialSizeInvalid3(TestContext context) {
    testSize(context, "/term/websocket?rows=abc", 80, 24);
  }

  @Test
  public void testInitialSizeInvalid4(TestContext context) {
    testSize(context, "/term/websocket?cols=abc", 80, 24);
  }
